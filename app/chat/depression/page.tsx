...
const roomInfo = {
  depression: {
    name: 'Depression Support Room',
    description: 'Peer support for dealing with depression and low mood',
    rules: ['Extreme empathy', 'No triggering content', 'Focus on small wins']
  },
};
