...
const roomInfo = {
  recovery: {
    name: 'Recovery Journey Room',
    description: 'Sharing recovery stories and progress updates',
    rules: ['Celebrate progress', 'No judgment', 'Share hope']
  }
};
